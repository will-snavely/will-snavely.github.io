...
looking at the compiled bytecode for these functions, but since that is
[somewhat involved, we'll save it for a later date.]({% post_url 2020-07-16-folding_at_home_p4 %})
Suffice to say, our observations support that idea that
